...
public class Hand {
	 ...
	 * int result = 0;
	 * 
	 * result = h1.getHandScore().getHandStrength() -
	 * h2.getHandScore().getHandStrength();
	 * 
	 ...
	 * if (result != 0) { return result; }
	 * 
	 * if ((h2.getHandScore().getKickers() == null) ||
	 * (h1.getHandScore().getKickers() == null)) { return 0; } if
	 * (h2.getHandScore().getKickers().get(eCardNo.FirstCard.getCardNo()) ==
	 * null) { return 0; } else { result =
	 * (h2.getHandScore().getKickers().get(eCardNo.FirstCard.getCardNo()).
	 * geteRank().getiRankNbr() -
	 * h1.getHandScore().getKickers().get(eCardNo.FirstCard.getCardNo()).
	 * geteRank().getiRankNbr()); if (result != 0) { return result; } }
	 * 
	 * result =
	 * (h2.getHandScore().getKickers().get(eCardNo.SecondCard.getCardNo()).
	 * geteRank().getiRankNbr() -
	 * h1.getHandScore().getKickers().get(eCardNo.SecondCard.getCardNo()).
	 * geteRank().getiRankNbr()); if (result != 0) { return result; }
	 * 
	 * result =
	 * (h2.getHandScore().getKickers().get(eCardNo.ThirdCard.getCardNo()).
	 * geteRank().getiRankNbr() -
	 * h1.getHandScore().getKickers().get(eCardNo.ThirdCard.getCardNo()).
	 * geteRank().getiRankNbr()); if (result != 0) { return result; }
	 * 
	 * result =
	 * (h2.getHandScore().getKickers().get(eCardNo.FourthCard.getCardNo()).
	 * geteRank().getiRankNbr() -
	 * h1.getHandScore().getKickers().get(eCardNo.FourthCard.getCardNo()).
	 * geteRank().getiRankNbr()); if (result != 0) { return result; }
	 * 
	 * return 0; } };
	 */
